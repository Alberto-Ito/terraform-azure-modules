### WARNING: Will be deleted on v2.0
variable "azresource" {
  default = ""
}

### WARNING: This property has been deprecated in favour of the 'storage_account_id' property and will be removed in version 2.0 of the module.
variable "resource_group_name" {
  description = "(Optional) Specifies the name of the storage account. Changing this forces a new resource to be created. This must be unique across the entire Azure service, not just within the resource group."
  type        = string
  default     = null
}
...
### WARNING: This property will be required in version 2.0 of the module.
variable "storage_account_id" {
  description = "(Optional) Specifies the ID of the storage account. Changing this forces a new resource to be created."
  type        = string
  default     = null
}
