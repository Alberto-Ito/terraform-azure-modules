variable "scope" {
  description = "Specifies the scope at which the Management Lock should be created. Changing this forces a new resource to be created. Example: /subscriptions/0000-0000-0000-0000/resourceGroups/P1/providers/Microsoft.Network/networkSecurityGroups/jptestRSL"
}
