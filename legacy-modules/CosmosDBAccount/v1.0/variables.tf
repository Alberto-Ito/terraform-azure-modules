...
variable "location" {
  description = "The main, write region were the resource will be deployed."
}
...
variable "interval_in_minutes" {
  ...
  default     = null #Default Value: 240
}
...
variable "storage_redundancy" {
  ...
  default     = null #Default Value: Geo
}
