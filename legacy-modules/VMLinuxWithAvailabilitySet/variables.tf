...
variable "azurerm_availability_set_name" {
  description = "The name of the Availability Set that the VM will use."
}

variable "availability_set_resource_group_name" {
  description = "The name of the resource group in which the Availability Set exists."
}
...
variable "azurerm_linux_virtual_machine_name" {
  description = "he name of the Linux Virtual Machine. Changing this forces a new resource to be created."
}
variable "size" {
